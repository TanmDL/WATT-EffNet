...
6) Proceed to train the model. This is found under training.py.
7) Finally, run the F1.py to output the F1 score, and the compute_flops.py to output the flops value.
